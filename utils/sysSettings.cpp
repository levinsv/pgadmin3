...
bool sysSettings::GetDisplayOption(const wxString &objtype, bool GetDefault)
{
	...
	else if (objtype == _("Subscriptions"))
		engtype = wxT("Subscriptions");
...
void sysSettings::SetDisplayOption(const wxString &objtype, bool display)
{
	...
	else if (objtype == _("Subscriptions")) engtype = wxT("Subscriptions");
...
wxString sysSettings::GetAutoReplaceFile()
{
	wxString s, tmp;
